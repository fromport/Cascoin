...
These are the dependencies currently used by Cascoin Core. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| Boost | [1.65.1](http://www.boost.org/users/download/) | [1.65.1](https://github.com/bitcoin/bitcoin/pull/8920) | No |  |  |
| ccache | [3.3.4](https://ccache.samba.org/download.html) |  | No |  |  |
| Clang |  | [5.0+](http://llvm.org/releases/download.html) (C++17 support) |  |  |  |
...
| Qt | [6.5.0](https://download.qt.io/official_releases/qt/) | 6.2+ | No |  |  |
