UNIX BUILD NOTES
====================
Some notes on how to build Cascoin Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Note
---------------------
Always use absolute paths to configure and compile cascoin and the dependencies,
...
memory available when compiling Cascoin Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Cascoin Core without wallet.
...
Once these are installed, they will be found by configure and a cascoin-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip cascoind" to strip the debug
...
Security
--------
To help make your cascoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, cascoin should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, cascoin may be compiled in
