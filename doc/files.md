...
* cascoin.conf: contains configuration settings for cascoind or cascoin-qt
* cascoind.pid: stores the process id of cascoind while running
...
* debug.log: contains debug information and general logging generated by cascoind or cascoin-qt
