...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cascoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cascoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cascoin transaction") + "\n" +
              "  cascoin-tx [options] -create [commands]   " + _("Create hex-encoded cascoin transaction") + "\n" +
              "\n";
