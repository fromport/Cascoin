...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = ALWAYS_ACTIVE; // January 1, 2008
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 2000000000; // December 31, 2008

        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = ALWAYS_ACTIVE; // January 28, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 2000000000; // January 31st, 2018

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = ALWAYS_ACTIVE; // January 28, 2017
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_HIVE].nStartTime = ALWAYS_ACTIVE; // Dec 26, 2018
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_HIVE_1_1].nStartTime = ALWAYS_ACTIVE;  // Sept 20, 2019
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MINOTAURX].nStartTime = ALWAYS_ACTIVE;  // 1200 UTC Sept 16, 2021
