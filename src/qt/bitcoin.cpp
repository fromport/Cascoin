...
#include <QtPlugin>
// #if QT_VERSION < 0x050000 // Removed Qt4 static plugins
// Q_IMPORT_PLUGIN(qcncodecs)
// Q_IMPORT_PLUGIN(qjpcodecs)
// Q_IMPORT_PLUGIN(qtwcodecs)
// Q_IMPORT_PLUGIN(qkrcodecs)
// Q_IMPORT_PLUGIN(qtaccessiblewidgets)
// #else // Qt5+ static plugins
...
int main(int argc, char *argv[])
{
    ...
    // Qt6 and Qt5 handle UTF-8 by default. No specific QTextCodec calls needed.
...
#endif
// #if QT_VERSION >= 0x050600 // AA_EnableHighDpiScaling is default in Qt6
...
// #if QT_VERSION < 0x050000 // Removed Qt4 message handler path
//     // Install qDebug() message handler to route to debug.log
//     qInstallMsgHandler(DebugMessageHandler);
// #else // Qt5/Qt6 message handler path
#if defined(Q_OS_WIN)
...
// #endif // End Qt5/Qt6 message handler path
