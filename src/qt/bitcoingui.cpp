...
void BitcoinGUI::createActions()
{
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cascoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cascoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a cascoin: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Cascoin command-line options").arg(tr(PACKAGE_NAME)));
    ...
    importPrivateKeyAction->setToolTip(tr("Import a Litecoin or Cascoin private key"));
    ...
    if(walletFrame)
    {
        ...
        connect(importPrivateKeyAction, SIGNAL(triggered()), walletFrame, SLOT(importPrivateKey()));    // Cascoin: Key import helper
    }
#endif // ENABLE_WALLET
...
void BitcoinGUI::createMenuBar()
{
    ...
    if(walletFrame)
    {
        ...
        file->addSeparator();
        file->addAction(importPrivateKeyAction);    // Cascoin: Key import helper
        file->addSeparator();                       // Cascoin: Key import helper
    }
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Cascoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Cascoin"); // default title
