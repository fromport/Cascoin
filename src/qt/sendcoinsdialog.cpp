...
void SendCoinsDialog::setModel(WalletModel *_model)
{
    ...
    if(_model && _model->getOptionsModel())
    {
        ...
        connect(ui->groupFee, QOverload<int>::of(&QButtonGroup::idClicked), this, &SendCoinsDialog::updateFeeSectionControls);
        connect(ui->groupFee, QOverload<int>::of(&QButtonGroup::idClicked), this, &SendCoinsDialog::coinControlUpdateLabels);
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Cascoin address"));
        }
        else // Valid address
        {
