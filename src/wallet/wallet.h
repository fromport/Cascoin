...
//! -fallbackfee default
static const CAmount DEFAULT_FALLBACK_FEE = 2000000 / COIN_SCALE / 10;          // Cascoin: 10X cheaper fees. Note these constants must also account for the 10X coinscale.
//! -m_discard_rate default
static const CAmount DEFAULT_DISCARD_FEE = 10000 / COIN_SCALE / 10;             // Cascoin: 10X cheaper fees. Note these constants must also account for the 10X coinscale.
//! -mintxfee default
static const CAmount DEFAULT_TRANSACTION_MINFEE = 100000 / COIN_SCALE / 10;     // Cascoin: 10X cheaper fees. Note these constants must also account for the 10X coinscale.
//! minimum recommended increment for BIP 125 replacement txs
static const CAmount WALLET_INCREMENTAL_RELAY_FEE = 5000 / COIN_SCALE / 10;     // Cascoin: 10X cheaper fees. Note these constants must also account for the 10X coinscale.
